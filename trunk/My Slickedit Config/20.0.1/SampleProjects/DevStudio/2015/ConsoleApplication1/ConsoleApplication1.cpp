 ...
 * <P>
 * You need Visual C++ 2010 if you want to build this
 * application.  If you want Context Tagging to work for the
 * Visual C++ run-times use the Automatic Tagging dialog
