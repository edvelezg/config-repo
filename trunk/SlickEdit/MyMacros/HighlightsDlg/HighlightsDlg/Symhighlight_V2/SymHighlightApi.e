...
/**
    symtag_add_word(word [color] [wholeWord])
    word is the string to highlight
    color is a color index or a color name
    wholeWord is a boolean, default if true
 * @example 
 *  symtag_add_word strcpy
*/
...
/** 
 *  symtag_clear_all_sym_highlights
...
_command void symtag_open_sym_highlights()
{
    ...
    // is displayed.
    g_windowId = show("-mdi Highlights");
}

/** 
 *  symtag_close_sym_highlights
