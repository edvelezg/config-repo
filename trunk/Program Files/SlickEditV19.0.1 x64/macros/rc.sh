...
#define CANNOT_OPEN_FIFO_FILE_RC -95
...
#define VSRC_CURSORS_ARG1 -2170
#define VSRC_TOOL_WINDOW_DOES_NOT_SUPPORT_DUPLICATES -2171
#define VSRC_INVALID_BUFFER_ID -2172
...
#define VS_TAG_FLAG_IMPLICIT_RC -3890
...
#define BT_OVERSIZED_DATABASE_OBJECT_RC -3987
...
#define VSTAG_TYPE_ASSIGN_RC -4061
#define VSTAG_TYPE_SELECTOR_RC -4062
#define VSTAG_TYPE_UNDEF_RC -4063
#define VSTAG_TYPE_CLAUSE_RC -4064
#define VSTAG_TYPE_CLUSTER_RC -4065
#define VSTAG_TYPE_PARTITION_RC -4066
#define VSTAG_TYPE_POLICY_RC -4067
#define VSTAG_TYPE_PROFILE_RC -4068
#define VSTAG_TYPE_USER_RC -4069
#define VSTAG_TYPE_ROLE_RC -4070
#define VSTAG_TYPE_SEQUENCE_RC -4071
#define VSTAG_TYPE_TABLESPACE_RC -4072
#define VSTAG_TYPE_QUERY_RC -4073
#define VSTAG_TYPE_ATTRIBUTE_RC -4074
#define VSTAG_TYPE_DATABASE_LINK_RC -4075
#define VSTAG_TYPE_DIMENSION_RC -4076
#define VSTAG_TYPE_DIRECTORY_RC -4077
#define VSTAG_TYPE_EDITION_RC -4078
#define VSTAG_TYPE_CONSTRAINT_RC -4079
#define VSTAG_TYPE_MONITOR_RC -4080
...
#define VSBUILDRC_DEPENCY_FROM_NOT_FOUND_4ARG -4259
...
#define VSCODEHELPRC_CONTEXT_NOT_VALID -4601
#define VSCODEHELPRC_NOT_IN_ARGUMENT_LIST -4602
#define VSCODEHELPRC_NO_HELP_FOR_FUNCTION -4603
#define VSCODEHELPRC_NO_SYMBOLS_FOUND -4604
#define VSCODEHELPRC_CONTEXT_EXPRESSION_TOO_COMPLEX -4605
#define VSCODEHELPRC_UNABLE_TO_EVALUATE_CONTEXT -4606
#define VSCODEHELPRC_DOT_FOR_POINTER -4607
#define VSCODEHELPRC_DASHGREATER_FOR_NON_POINTER -4608
#define VSCODEHELPRC_INVALID_NEW_EXPRESSION -4609
#define VSCODEHELPRC_PARENTHESIS_MISMATCH -4610
#define VSCODEHELPRC_BRACKETS_MISMATCH -4611
#define VSCODEHELPRC_DASHGREATER_FOR_PTR_TO_POINTER -4612
#define VSCODEHELPRC_SUBSCRIPT_BUT_NOT_ARRAY_TYPE -4613
#define VSCODEHELPRC_OVERLOADED_RETURN_TYPE -4614
#define VSCODEHELPRC_NOT_A_TEMPLATE_CLASS -4615
#define VSCODEHELPRC_RETURN_TYPE_NOT_FOUND -4616
#define VSCODEHELPRC_TEMPLATE_ARGS_MISMATCH -4617
#define VSCODEHELPRC_BUILTIN_TYPE -4618
#define VSCODEHELPRC_NO_LABELS_DEFINED -4619
#define VSCODEHELPRC_DOT_FOR_ARRAY -4620
#define VSCODEHELPRC_LIST_PARAMS_NOT_SUPPORTED -4621
#define VSCODEHELPRC_RETURN_TYPE_IS_VOID -4622
#define VSCODEHELPRC_LIST_MEMBERS_TIMEOUT -4623
#define VSCODEHELPRC_FUNCTION_HELP_TIMEOUT -4624
#define VSCODEHELPRC_LIST_MEMBERS_LIMITED -4623
...
#define SVC_COULD_NOT_GET_REMOTE_FILE -6699
...
#define VSDIFF_LINE_TOO_LONG_RC -7007
...
#define WINDBG_ERROR_NONE_RC -9301
#define WINDBG_ERROR_INIT_FAILED -9302
#define WINDBG_ERROR_CREATE_PROCESS_RC -9303
#define WINDBG_ERROR_ATTACH_PROCESS_RC -9304
#define WINDBG_ERROR_OPEN_DUMP_FILE_RC -9305
#define WINDBG_ERROR_WRITE_DUMP_FILE_RC -9306
#define WINDBG_ERROR_DETACH_PROCESS_RC -9307
#define WINDBG_ERROR_TERMINATE_PROCESS_RC -9308
#define WINDBG_ERROR_RESUMING_RC -9309
#define WINDBG_ERROR_SUSPENDING_RC -9310
#define WINDBG_ERROR_EXECUTION_STATUS_RC -9311
#define WINDBG_ERROR_GET_THREADS_RC -9312
#define WINDBG_ERROR_GET_CURRENT_THREAD_RC -9313
#define WINDBG_ERROR_SET_CURRENT_THREAD_RC -9314
#define WINDBG_ERROR_GET_REGISTERS_RC -9315
#define WINDBG_ERROR_EVALUATE_RC -9316
#define WINDBG_ERROR_GET_MEMORY_RC -9317
#define WINDBG_ERROR_GET_STACK_RC -9318
#define WINDBG_ERROR_SET_SCOPE_RC -9319
#define WINDBG_ERROR_GET_LOCALS_RC -9320
#define WINDBG_ERROR_MODIFY_VAR_RC -9321
#define WINDBG_ERROR_GET_THIS_RC -9322
#define WINDBG_ERROR_ENABLE_BREAKPOINT_RC -9323
#define WINDBG_ERROR_EVALUATE_BREAKPOINT_RC -9324
#define WINDBG_ERROR_SYMBOLGROUP_RC -9325
#define WINDBG_ERROR_SYMBOL_NAME_RC -9326
#define WINDBG_ERROR_SYMBOL_TYPENAME_RC -9327
#define WINDBG_ERROR_SYMBOL_PARAMETERS_RC -9328
#define WINDBG_ERROR_EXPAND_VAR_RC -9329
#define WINDBG_ERROR_GET_OFFSET_LINE_RC -9330
#define WINDBG_NO_MORE_EVENTS_RC -9331
#define WINDBG_ERROR_DBGENG_FAILED_RC -9332
#define WINDBG_ERROR_WRITESYMBOL_FAILED_RC -9333
#define WINDBG_ERROR_DEBUGCREATE_FAILED_RC -9334
#define WINDBG_ERROR_QUERY_FAILED_RC -9335
#define WINDBG_ERROR_ADDSYMBOLGROUP_RC -9336
#define WINDBG_ERROR_WATCH_RC -9337
#define WINDBG_ERROR_GET_GROUP_RC -9338
#define WINDBG_INVALID_DEBUGGER_ARGS_RC -9339
#define WINDBG_SYMBOL_TIMED_OUT_RC -9340
#define WINDBG_ERROR_UNSUPPORTED_RC -9341
#define WINDBG_END_ERRORS -9400
...
#define VSRC_CAPTION_CURRENT_ENCODING -101396
...
#define VSRC_SHOW_SYMBOL -101512
#define VSRC_SHOW_SYMBOL_NO_WORD -101513
#define VSRC_FIND_REFS -101514
#define VSRC_FIND_REFS_NO_WORD -101515
#define VSRC_GO_TO_REFS -101516
#define VSRC_GO_TO_REFS_NO_WORD -101517
#define VSRC_GEN_DEBUG -101518
#define VSRC_GEN_DEBUG_NO_WORD -101519
#define VSRC_GO_TO_DEF -101520
#define VSRC_GO_TO_DEF_NO_WORD -101521
#define VSRC_CFG_RESET_WINDOW_LAYOUT -101522
#define VSRC_GO_TO_INCLUDE -101523
#define VSRC_NO_CURRENT_WORKSPACE -101524
#define VSRC_NO_CURRENT_PROJECT -101525
...
#define CMRC_EOF -102699
#define CMRC_FILE_NOT_FOUND_1ARG -102698
#define CMRC_PATH_NOT_FOUND_1ARG -102697
#define CMRC_TOO_MANY_OPEN_FILES -102696
#define CMRC_ACCESS_DENIED_1ARG -102695
#define CMRC_INVALID_HANDLE -102694
#define CMRC_MEMORY_CONTROL_BLOCKS -102693
#define CMRC_INSUFFICIENT_MEMORY -102692
#define CMRC_INVALID_DRIVE -102691
#define CMRC_CURRENT_DIRECTORY_CAN_NOT_BE_REMOVED -102690
#define CMRC_ERROR_READING_FILE_1ARG -102689
#define CMRC_ERROR_WRITING_FILE_1ARG -102688
#define CMRC_ERROR_CLOSING_FILE_1ARG -102687
#define CMRC_ERROR_OPENING_FILE_1ARG -102686
#define CMRC_NO_MORE_FILES -102685
#define CMRC_FINDOPEN_NOT_CALLED -102684
#define CMRC_INSUFFICIENT_DISK_SPACE -102683
#define CMRC_ERROR_SEEKING_IN_FILE_1ARG -102682
#define CMRC_MEDIA_IS_WRITE_PROTECTED -102681
#define CMRC_ERROR_TRUNCATING_FILE_1ARG -102680
#define CMRC_INVALID_FILENAME -102679
#define CMRC_WRITING_TO_FILES_OF_THIS_TYPE_NOT_SUPPORTED -102678
#define CMRC_ERROR_CREATING_DIRECTORY_1ARG -102677
#define CMRC_DEVICE_NOT_READY -102676
#define CMRC_BAD_COMMAND -102675
#define CMRC_ERROR_CRC -102674
#define CMRC_BAD_LENGTH -102673
#define CMRC_SECTOR_NOT_FOUND -102672
#define CMRC_OUT_OF_PAPER -102671
#define CMRC_DISK_FULL -102670
#define CMRC_PRINT_CANCALLED -102669
#define CMRC_IO_ERROR -102668
#define CMRC_NOT_A_DIRECTORY -102667
#define CMRC_BUFFER_TOO_SMALL -102666
#define CMRC_INVALID_NAME -102665
#define CMRC_ERROR_CHANGING_PERMISSIONS_OF_FILE_1ARG -102664
#define CMRC_ERROR_CHANGING_OWNER_OF_FILE_1ARG -102663
#define CMRC_ERROR_DELETING_FILE_1ARG -102662
#define CMRC_ERROR_SETTING_FILE_DATE_1ARG -102661
#define CMRC_ERROR_OPENING_STANDARD_FILE -102660
#define CMRC_INVALID_ARGUMENT -102659
#define CMRC_DUPLICATE_KEY -102658
#define CMRC_KEY_NOT_FOUND -102657
#define CMRC_INVALID_ARGUMENT_1ARG -102656
#define CMRC_CALL_FAILED_2ARG -102655
#define CMRC_INVALID_DATE_ARGUMENT_1ARG -102654
#define CMRC_INVALID_ZIP_OR_JAR_FILE_1ARG -102653
#define CMRC_FILE_LISTING_NOT_SUPPORTED -102652
#define CMRC_FILE_OPERATION_NOT_SUPPORTED -102651
#define CMRC_ZIP_OR_JAR_DECOMPRESSION_FAILED_1ARG -102650
#define CMRC_ERROR_READING_ZIP_OR_JAR_ITEM_1ARG -102649
#define CMRC_TREE_CORRUPT_CHILD_NODE_MISSING_PARENT -102648
#define CMRC_NO_PROCESS_TO_WAIT_ON -102647
#define CMRC_ERROR_STARTING_PROCESS -102646
#define CMRC_ERROR_GETTING_EXIT_CODE -102645
#define CMRC_NO_PROCESS_RUNNING -102644
#define CMRC_INVALID_FIND_OPTION_SPECIFIED -102643
#define CMRC_EOL1 -102642
#define CMRC_EOL2 -102641
#define CMRC_EOL0 -102640
#define CMRC_INVALID_PERMISSION_STRING_1ARG -102639
#define CMRC_ERROR_SETTING_FILE_PERMISSIONS_1ARG -102638
#define CMRC_STARTINDEX_CANNOT_BE_LARGER_THAN_LENGTH -102637
#define CMRC_INDEX_AND_LENGTH_MUST_BE_WITHIN_STRING -102636
#define CMRC_INDEX_AND_LENGTH_MUST_BE_WITHIN_ARRAY -102635
#define CMRC_LENGTH_TOO_LARGE -102634
#define CMRC_ADDING_AFTER_OR_BEFORE_NODE_NOT_IN_LIST -102633
#define CMRC_REMOVE_CALLED_WHEN_LIST_IS_EMPTY -102632
#define CMRC_DEQUEUE_CALLED_WHEN_QUEUE_IS_EMPTY -102631
#define CMRC_DLL_SYMBOL_NOT_FOUND_1ARG -102630
#define CMRC_TIMEOUT -102629
#define CMRC_INVALID_FILE_DESCRIPTOR -102628
#define CMRC_NETWORK_IS_UNREACHABLE -102627
#define CMRC_FINDFILE_NOT_SUPPORTED_FOR_FILES_OF_THIS_TYPE -102626
#define CMRC_MAKEDIR_NOT_SUPPORTED_FOR_FILES_OF_THIS_TYPE_ARG1 -102625
#define CMRC_INVALID_PORT_ADDRESS_ARG1 -102624
#define CMRC_ERROR_REMOVING_DIRECTORY_1ARG -102623
#define CMRC_INVALID_OPTION -102622
#define CMRC_OPERATION_CANCELLED -102621
#define CMRC_POTENTIAL_DEADLOCK_DETECTED -102620
#define CMRC_THREAD_STILL_RUNNING -102619
#define CMRC_INFINITE_LOOP_DETECTED_IN_COMMAND_2ARG -102618
#define CMRCEND_COMMON -102700

///////////////////////////////////////////////////////////////////////////////
// REGEX
///////////////////////////////////////////////////////////////////////////////

#define CMRC_REGEX_INVALID_UTF8_CHARACTER_IN_REGULAR_EXPRESSION -103099
#define CMRC_REGEX_EXPECTING_OPEN_BRACE -103098
#define CMRC_REGEX_EXPECTING_CLOSE_BRACE -103097
#define CMRC_REGEX_UNKNOWN_UNICODE_CHARACTER_NAME_1ARG -103096
#define CMRC_REGEX_MUST_SURROUND_BACKREFENCE_NAME_WITH -103095
#define CMRC_REGEX_BACKREFENCE_NAME_NOT_TERMINATED -103094
#define CMRC_REGEX_BACKREFENCE_NAME_NOT_FOUND_1ARG -103093
#define CMRC_REGEX_EXPECTING_CLOSE_PAREN -103092
#define CMRC_REGEX_INVALID_CONTROL_ESCAPE_CHARACER -103091
#define CMRC_REGEX_INVALID_HEX_ESCAPE_CHARACTER -103090
#define CMRC_REGEX_INVALID_DECIMAL_ESCAPE_CHARACTER -103089
#define CMRC_REGEX_UNRECOGNIZED_ESCAPE_1ARG -103088
#define CMRC_REGEX_CHARACTER_SET_NOT_TERMINATED -103087
#define CMRC_REGEX_CHARACTER_SET_SUBTRACTION_OR_INTERSECTION_MUST_BE_LAST -103086
#define CMRC_REGEX_UNICODE_ESCAPE_CHARACTER_MUST_BE_4_HEX_DIGITS -103085
#define CMRC_REGEX_QUANTIFIER_FOLLOWS_NOTHING -103084
#define CMRC_REGEX_INVALID_COLON_CATEGORY -103083
#define CMRC_REGEX_INVALID_QUANTIFIER -103082
#define CMRC_REGEX_INVALID_REGULAR_EXPRESSION -103081
#define CMRC_REGEX_INVALID_BACKREFERENCE_NAME -103080
#define CMRC_REGEX_BREAK_KEY_PRESSED -103079
#define CMRC_REGEX_RECURSION_TOO_DEEP -103078
#define CMRC_REGEX_INVALID_WORD_RE -103077
#define CMRC_REGEX_EXPECTING_CLOSE_BRACE_FOR_PROPERTY_NAME -103076
#define CMRC_REGEX_EXPECTING_CLOSE_BRACKET_TO_CLOSE_POSIX_NAME -103075
#define CMRC_REGEX_CANT_FIND_PROPERTY_1ARG -103074
#define CMRC_REGEX_EXPECTING_CLOSE_BRACE_FOR_HEX_ESCAPE_CHARACTER -103073
#define CMRC_REGEX_EXPECTING_CLOSE_BRACE_FOR_DECIMAL_ESCAPE_CHARACTER -103072
#define CMRC_REGEX_INVALID_TAGGED_EXPRSSION_NAME_1ARG -103071
#define CMRC_REGEX_EXPECTING_CLOSE_BRACE_FOR_UNICODE_CHARACTER_NAME -103070
#define CMRC_REGEX_EXPECTING_OPEN_BRACE_FOR_UNICODE_CHARACTER_NAME_SPEC -103069
#define CMRC_REGEX_INVALID_OCTAL_ESCAPE_CHARACTER -103068
#define CMRC_REGEX_INVALID_CONDITION_IN_YES_NO_PATTERN -103067
#define CMRCEND_REGEX -103100

///////////////////////////////////////////////////////////////////////////////
// FTP
///////////////////////////////////////////////////////////////////////////////

#define CMRC_FTP_FAILED_TO_CONNECT_2ARG -103699
#define CMRC_FTP_FAILED_TO_CONNECT_3ARG -103698
#define CMRC_FTP_COMMAND_FAILED_2ARG -103697
#define CMRC_FTP_PASS_COMMAND_FAILED_1ARG -103696
#define CMRC_FTP_DATAPORT_ACCEPT_CONNECTION_FAILED -103695
#define CMRC_FTP_UNABLE_TO_OPEN_A_DATA_PORT -103694
#define CMRC_FTP_COMMAND_ABORTED -103693
#define CMRCEND_FTP -103700

///////////////////////////////////////////////////////////////////////////////
// DB
///////////////////////////////////////////////////////////////////////////////

#define CMRC_DB_RECORD_NOT_FOUND -103799
#define CMRC_DB_FEATURE_NOT_SUPPORTED -103798
#define CMRC_DB_NO_MORE_DUPLICATES -103797
#define CMRC_DB_REMOVED_LAST_DUPLICATE -103796
#define CMRC_DB_INVALID_RECORD_LOCATION -103795
#define CMRC_DB_MISSING_REQUIRED_FIELD -103794
#define CMRC_DB_CACHE_BLOCK_INDEX_OUT_OF_RANGE -103793
#define CMRC_DB_RECORD_TOO_LARGE_FOR_BLOCK -103792
#define CMRC_DB_INVALID_SIGNATURE_1ARG -103791
#define CMRC_DB_DATABASE_CORRUPT_1ARG -103790
#define CMRC_DB_DATABASE_CORRUPT_FILESIZE_INCORRECT_1ARG -103789
#define CMRC_DB_TOO_MANY_INDEX_FIELDS -103788
#define CMRC_DB_FIELD_NOT_FOUND -103787
#define CMRC_DB_TABLE_TOO_COMPLEX -103786
#define CMRC_DB_FIELD_ALREADY_DEFINED -103785
#define CMRC_DB_ALL_STRING_FIELDS_MUST_BE_DEFINED_FIRST -103784
#define CMRC_DB_DATABASE_HAS_INCORRECT_MACHINE_ARCHITECTURE_1ARG -103783
#define CMRC_DB_SYMBOL_DATABASE_IS_STILL_OPEN_1ARG -103782
#define CMRC_DB_OPENING_OR_CREATING_NOT_ALLOW_DURING_CLOSE_ALL_OPERATION -103781
#define CMRC_DB_LOADANDCLOSE_ONLY_SUPPORTED_FOR_READ_ONLY_IN_MEMORY_DATABASES -103780
#define CMRC_DB_FREE_LARGE_CALLED_WITH_INVALID_CAPACITY_SIZE -103779
#define CMRC_DB_FREE_LARGE_CALLED_WITH_INVALID_SEEK_POSITION -103778
#define CMRC_DB_CANT_CLOSE_SYMBOL_DATABASE_FROM_CURRENT_THREAD -103777
#define CMRCEND_DB -103800

///////////////////////////////////////////////////////////////////////////////
// LICENSE
///////////////////////////////////////////////////////////////////////////////

#define CMRC_LICENSE_MUST_HAVE_ENCRYPT_ELEMENT -103999
#define CMRC_LICENSE_ISSUED_DATE_ATTRIBUTE_IS_NOT_VALID -103998
#define CMRC_LICENSE_START_DATE_ATTRIBUTE_IS_NOT_VALID -103997
#define CMRC_LICENSE_EXPIRES_DATE_ATTRIBUTE_IS_NOT_VALID -103996
#define CMRC_LICENSE_MUST_HAVE_PRODUCT_INFO_ELEMENT -103995
#define CMRC_LICENSE_PRODUCT_VERSION_ATTRIBUTE_IS_NOT_VALID -103994
#define CMRC_LICENSE_INVALID_LICENSE_FILE -103993
#define CMRC_LICENSE_EXPIRED -103992
#define CMRC_LICENSE_NOT_VALID_FOR_CONFIGURATION -103991
#define CMRC_LICENSE_IS_FOR_AN_OLDER_VERSION -103990
#define CMRC_LICENSE_NOT_VALID_FOR_THIS_PRODUCT -103989
#define CMRC_LICENSE_NOT_VALID_BEFORE_START_DATE -103988
#define CMRC_LICENSE_MUST_HAVE_NON_BLANK_VENDOR_ID -103987
#define CMRC_LICENSE_MUST_HAVE_NON_BLANK_PRODUCT_ID -103986
#define CMRC_LICENSE_BORROWED_LICENSE_FAILURE_1ARG -103985
#define CMRC_LICENSE_BORROW_REQUIRES_PRODUCT_BE_CHECKED_OUT -103984
#define CMRC_LICENSE_RETURN_REQUIRES_PRODUCT_BE_CHECKED_OUT -103983
#define CMRC_LICENSE_PRODUCT_ALREADY_CHECKED_OUT -103982
#define CMRC_LICENSE_PRODUCT_NOT_CHECKED_OUT -103981
#define CMRC_LICENSE_HOSTID_NOT_VALID_FOR_CONFIGURATION -103980
#define CMRC_LICENSE_DISK_SERIAL_NUMBER_NOT_VALID_FOR_CONFIGURATION -103979
#define CMRC_LICENSE_HOST_NAME_NOT_VALID_FOR_CONFIGURATION -103978
#define CMRC_LICENSE_USER_NAME_NOT_VALID_FOR_CONFIGURATION -103977
#define CMRC_LICENSE_MISSING_SIGN_ELEMENT -103976
#define CMRC_LICENSE_MISSING_ENCRYPT_ELEMENT -103975
#define CMRC_LICENSE_INVALID_RESULT -103974
#define CMRC_LICENSE_INVALID_CHARACTERS_IN_VENDOR_ID -103973
#define CMRC_LICENSE_INVALID_CHARACTERS_IN_PRODUCT_ID -103972
#define CMRC_LICENSE_LICUTIL_HELP -103971
#define CMRC_LICENSE_HASH_FAILED -103970
#define CMRCEND_LICENSE -104000

///////////////////////////////////////////////////////////////////////////////
// PARSER
///////////////////////////////////////////////////////////////////////////////

#define CMRC_PARSER_NO_PARSER_FOR_FILE_1ARG -104199
#define CMRC_PARSER_FAILED_TO_CREATE_PARSER_1ARG -104198
#define CMRCEND_PARSER -104200
