...
#define EX_CMDS " ! = < > & ABBREVIATE BUFFER BDELETE BNEXT BPREVIOUS BUFFERS BUFDO CD COPY CLOSE DELETE EDIT FILE GLOBAL HELP JOIN K LIST":+\
 ...
 */
#define PLAYBACK_CMDS ' vi-toggle-char-visual vi-toggle-line-visual vi-toggle-block-visual':+\
