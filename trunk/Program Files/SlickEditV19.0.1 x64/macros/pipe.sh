 ...
 * @param options String of one or more options:<br>
 *                'C' - (Windows) Create a console for
 *                the spawned program.<br>
 *                'H' - (Windows) Show program hidden.
 *                Useful for console applications that
 *                should be "heard but not seen."
 *
 * <p>
 * Use _PipeRead to read from the process'
 * stdout and stderr. Use _PipeWrite to write to stdin.
 * </p>
 *
