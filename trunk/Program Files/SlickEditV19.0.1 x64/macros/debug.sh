...
#define VSDEBUG_EVENT_SUSPEND_ALL         0x0001
#define VSDEBUG_EVENT_SUSPEND_THREAD      0x0002
#define VSDEBUG_EVENT_GOTOPC              0x0004
#define VSDEBUG_EVENT_STOP                0x0008

// thread flags
#define VSDEBUG_THREAD_FLAG_ZOMBIE        0x0001
#define VSDEBUG_THREAD_FLAG_RUNNING       0x0002
#define VSDEBUG_THREAD_FLAG_SLEEPING      0x0004
#define VSDEBUG_THREAD_FLAG_MONITOR       0x0008
#define VSDEBUG_THREAD_FLAG_WAIT          0x0010
#define VSDEBUG_THREAD_FLAG_SUSPENDED     0x0020
#define VSDEBUG_THREAD_FLAG_FROZEN        0x0040

// class, field, and method modifier flags
#define VSDEBUG_FLAG_PUBLIC           0x00000001
#define VSDEBUG_FLAG_PACKAGE          0x00000002
#define VSDEBUG_FLAG_PROTECTED        0x00000004
#define VSDEBUG_FLAG_PRIVATE          0x00000008
#define VSDEBUG_FLAG_FINAL            0x00000010
#define VSDEBUG_FLAG_SUPER            0x00000020
#define VSDEBUG_FLAG_INTERFACE        0x00000040
#define VSDEBUG_FLAG_ABSTRACT         0x00000080
#define VSDEBUG_FLAG_STATIC           0x00000100
#define VSDEBUG_FLAG_TRANSIENT        0x00000200
#define VSDEBUG_FLAG_SYNCHRONIZED     0x00000400
#define VSDEBUG_FLAG_VOLATILE         0x00000800
#define VSDEBUG_FLAG_NATIVE           0x00001000
#define VSDEBUG_FLAG_VERIFIED         0x00002000
#define VSDEBUG_FLAG_PREPARED         0x00004000
#define VSDEBUG_FLAG_INITIALIZED      0x00008000
#define VSDEBUG_FLAG_ERROR            0x00010000
#define VSDEBUG_FLAG_SYNTHETIC        0x00020000
#define VSDEBUG_FLAG_ARRAY            0x00040000

// constants for items expanded under classes
#define VSDEBUG_CLASS_FIELDS          0x00000001
#define VSDEBUG_CLASS_METHODS         0x01000000

// constants for exceptions stop condition
#define VSDEBUG_EXCEPTION_STOP_WHEN_THROWN    0x1
#define VSDEBUG_EXCEPTION_STOP_WHEN_CAUGHT    0x2
#define VSDEBUG_EXCEPTION_STOP_WHEN_UNCAUGHT  0x4

// indices of the tabs on the debugger properties dialog
#define VSDEBUG_PROPS_INFORMATION_TAB     0
#define VSDEBUG_PROPS_SETTINGS_TAB        1
#define VSDEBUG_PROPS_NUMBERS_TAB         2
#define VSDEBUG_PROPS_FILTERS_TAB         3
#define VSDEBUG_PROPS_DIRECTORIES_TAB     4
#define VSDEBUG_PROPS_CONFIGURATIONS_TAB  5

// breakpoint types
#define VSDEBUG_BREAKPOINT_LINE           0
#define VSDEBUG_BREAKPOINT_METHOD         1
#define VSDEBUG_BREAKPOINT_ADDRESS        2
#define VSDEBUG_WATCHPOINT_READ           3
#define VSDEBUG_WATCHPOINT_WRITE          4
#define VSDEBUG_WATCHPOINT_ANY            5

// breakpoint flags
#define VSDEBUG_WATCHPOINT_INSTANCE       0x01
#define VSDEBUG_WATCHPOINT_STOP_ACTIVATE  0x02
...
// Update all views
#define VSDEBUG_UPDATE_ALL             1

// Debugger initialization and finalization
#define VSDEBUG_UPDATE_INITIALIZE      2
#define VSDEBUG_UPDATE_FINALIZE        3

// Debugger version information
#define VSDEBUG_UPDATE_VERSION         4

// Threads and stack frames
// use dbg_get_cur_thread() and dbg_get_cur_frame()
#define VSDEBUG_UPDATE_THREADS         5
#define VSDEBUG_UPDATE_CUR_THREAD      6
#define VSDEBUG_UPDATE_STACK           7
#define VSDEBUG_UPDATE_CUR_FRAME       8
#define VSDEBUG_UPDATE_SUSPENDED       9

// Variables of different types
#define VSDEBUG_UPDATE_VARIABLES      10
#define VSDEBUG_UPDATE_LOCALS         11
#define VSDEBUG_UPDATE_MEMBERS        12
#define VSDEBUG_UPDATE_AUTOVARS       13
#define VSDEBUG_UPDATE_WATCHES        14

// classes, registers, memory
#define VSDEBUG_UPDATE_CLASSES        15
#define VSDEBUG_UPDATE_REGISTERS      16
#define VSDEBUG_UPDATE_MEMORY         17

// breakpoints and exceptions
#define VSDEBUG_UPDATE_BREAKPOINTS    18
#define VSDEBUG_UPDATE_EXCEPTIONS     19

// enabled-ness of buttons
#define VSDEBUG_UPDATE_BUTTONS        20

// anything else
#define VSDEBUG_UPDATE_MISCELLANEOUS  21

// disassembly
#define VSDEBUG_UPDATE_DISASSEMBLY    22

// start of user-defined callback reasons
#define VSDEBUG_UPDATE_USER           100

// Constants for bases number values can be displayed in
#define VSDEBUG_BASE_DEFAULT     0
#define VSDEBUG_BASE_BINARY      2
#define VSDEBUG_BASE_OCTAL       8
#define VSDEBUG_BASE_DECIMAL     10
#define VSDEBUG_BASE_HEXADECIMAL 16
#define VSDEBUG_BASE_CHAR       256

#define VSDEBUG_LOG              'debug'
 ...
 * @since 10.0
 */
extern int dbg_create_new_session(_str package_name, _str session_name, boolean copy_setup);
 ...
 * @since 10.0
 */
extern int dbg_session_step_into(int session_id, int thread_id);
 ...
 * @since 10.0
 */
extern int dbg_session_update_registers(int session_id);
 ...
 * @categories Debugger_Functions
 */
extern int dbg_update_class_tree(int tree_wid,int tree_index,_str class_path,boolean hide_system=false);
/**
 ...
 * @categories Debugger_Functions
 */
extern int dbg_update_thread_list(int list_wid, boolean only_suspended);
/**
 ...
 * @categories Debugger_Functions
 */
extern int dbg_update_registers_tree(int tree_wid,int tree_index);
 ...
 * @deprecated Use the dbg_session_* callbacks.
 */
extern int dbg_gdb_do_command(_str command, var reply, _str &errmsg, boolean parse_reply);
/**
 * Get the version information for the debugger.
 *
 * @param description     Description of debugger implementation and version
 ...
 * @deprecated Use the dbg_session_* callbacks.
 */
extern int dbg_gdb_update_registers();
/**
 * Update the watched memory region.
 *
 * @param address    Start address to dump
 ...
 *
 * @param thread_id  Frame to set frame ID for
 ...
 * @categories Debugger_Functions
 */
extern int dbg_get_num_registers();
/**
 ...
 * @categories Debugger_Functions
 */
extern int dbg_get_register(int reg_id,_str &name,_str &value);
/**
 ...
 * @categories Debugger_Functions
 */
extern int dbg_set_register(int reg_id, _str value);
/**
 ...
 * @categories Debugger_Functions
 */
extern int dbg_find_breakpoint(_str file_name,int line_number,boolean &enabled,
...
extern int dbg_get_exception(int exception_id,
                      ...
                      _str &thread_name, boolean &enabled);
/**
 ...
 * @categories Debugger_Functions
 */
extern int dbg_clear_registers();
