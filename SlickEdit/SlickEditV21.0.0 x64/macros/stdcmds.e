 ...
 */
boolean def_softwrap_home_end=true;
/**
 ...
 * @categories Configuration_Variables
 */
boolean def_strict_nosplit_insert_line=false;
...
definit()
{
   ...
   if ( initArg :!= 'L' ) {
      ...
      load_picture(-1,'_browseOpenMac.bmp');
      load_picture(-1,'_browseOpenUnix.bmp');
      load_picture(-1,'_browseOpen.bmp');
      ...
      load_picture(-1,'_push_clipboard.ico');
      ...
      load_picture(-1,'_fldopen_mac.png');
      load_picture(-1,'_fldclos_mac.png');
      load_picture(-1,'_fldopen_mac.png');
      load_picture(-1,'_fldclos12_mac.png');
      load_picture(-1,'_fldopen12_mac.png');
      load_picture(-1,'_fldaop.ico');
      load_picture(-1,'_fldclos.ico');
      load_picture(-1,'_fldopen.ico');
      load_picture(-1,'_fldclos12.ico');
      load_picture(-1,'_fldopen12.ico');
      ...
      _pic_file_lock = load_picture(-1, '_file_lock.ico');
      if (_pic_file_lock >= 0) {
      ...
      _pic_diff_doc_bitmap = load_picture(-1,"_diff_doc.ico");
      _pic_del_diff_doc_bitmap = load_picture(-1,"_diff_doc_del.ico");
      ...
      if ( _pic_otb_file_disk_open ) {
         set_name_info(_pic_otb_file_disk_open,"This file is currently open");
      }
      ...
      if ( _pic_otb_file_proj_open ) {
         set_name_info(_pic_otb_file_proj_open,"This file is in the current project, and is currently open");
      }
      ...
      if ( _pic_otb_file_wksp_open ) {
         set_name_info(_pic_otb_file_wksp_open,"This file is in the current workspace, and is currently open");
      }
      ...
      load_picture(-1, '_fldcdup_mac.png');
      load_picture(-1, '_computer_mac.png');
      load_picture(-1, '_drfix2_mac.png');
      load_picture(-1, '_fldcdup.ico');
      load_picture(-1, '_computer.ico');
      load_picture(-1, '_drfix2.ico');

      load_picture(-1, '_blgrip.ico');
      load_picture(-1, '_tdown.ico');
      load_picture(-1, '_tup.ico');
      load_picture(-1, '_tdown2.ico');
      load_picture(-1, '_tup2.ico');
      load_picture(-1, '_tleft.ico');
      load_picture(-1, '_tright.ico');
      load_picture(-1, '_cbmenu.ico');
...
#define VSBPFLAGC_NOFBITMAPS (0x0f+1)
   ...
   if (_isMac()) {
      _pic_otb_cd_up = _find_or_add_picture('_fldcdup_mac.png');
      _pic_otb_computer = _find_or_add_picture('_computer_mac.png');
      _pic_otb_fixed = _find_or_add_picture('_drfix2_mac.png');
   } else {
      _pic_otb_cd_up = _find_or_add_picture('_fldcdup.ico');
      _pic_otb_computer = _find_or_add_picture('_computer.ico');
      _pic_otb_fixed = _find_or_add_picture('_drfix2.ico');
   }

   if (_isMac()) {
      _pic_fldaop=_find_or_add_picture('_fldopen_mac.png');
      _pic_fldclos=_find_or_add_picture('_fldclos_mac.png');
      _pic_fldopen=_find_or_add_picture('_fldopen_mac.png');
      _pic_fldclos12=_find_or_add_picture('_fldclos12_mac.png');
      _pic_fldopen12=_find_or_add_picture('_fldopen12_mac.png');
   } else {
      _pic_fldaop=_find_or_add_picture('_fldaop.ico');
      _pic_fldclos=_find_or_add_picture('_fldclos.ico');
      _pic_fldopen=_find_or_add_picture('_fldopen.ico');
      _pic_fldclos12=_find_or_add_picture('_fldclos12.ico');
      _pic_fldopen12=_find_or_add_picture('_fldopen12.ico');
   }
 ...
 *
 */
_command boolean ispf_enter() name_info(','VSARG2_MULTI_CURSOR|VSARG2_LASTKEY|VSARG2_CMDLINE|VSARG2_ICON|VSARG2_REQUIRES_EDITORCTL|VSARG2_READ_ONLY)
{
 ...
 */
_command void first_non_blank(...) name_info(','VSARG2_MULTI_CURSOR|VSARG2_READ_ONLY|VSARG2_REQUIRES_EDITORCTL)
{
   if (_on_line0()) {
      p_col=1;
      return;
 ...
 * @categories Combo_Box_Methods, CursorMovement_Functions, Edit_Window_Methods, Editor_Control_Methods, Text_Box_Methods
 */
_command void end_line() name_info(','VSARG2_MULTI_CURSOR|VSARG2_READ_ONLY|VSARG2_TEXT_BOX|VSARG2_REQUIRES_EDITORCTL|VSARG2_LINEHEX)
{
   if ( command_state() ) {
      _end_line();
      return;
 ...
 * @categories Combo_Box_Methods, CursorMovement_Functions, Edit_Window_Methods, Editor_Control_Methods, Text_Box_Methods
 */
_command void end_line_text_toggle() name_info(','VSARG2_MULTI_CURSOR|VSARG2_READ_ONLY|VSARG2_TEXT_BOX|VSARG2_REQUIRES_EDITORCTL|VSARG2_LINEHEX)
{
                   ...
                   _str doScreenLinesStr='')
{
   ...
   boolean doHexUpDown=((!select_active() && p_hex_mode==HM_HEX_LINE) || p_hex_mode==HM_HEX_ON);
   typeless downp;
   save_pos(downp);
...
void wordwrap_rubout(...)
{
   ...
   boolean check_wordwrap=(p_word_wrap_style&WORD_WRAP_WWS)!=0 && _insert_state() && !_on_line0();
   int non_blank_col=0;
 ...
 */
_command int begin_select(_str markid='',boolean LockSelection=true,boolean RestoreScrollPos=false) name_info(','VSARG2_MULTI_CURSOR|VSARG2_MARK|VSARG2_READ_ONLY|VSARG2_REQUIRES_EDITORCTL)
{
   int temp_view_id=0;
   int orig_view_id=0;
   if (!_isEditorCtl()) {
...
int _copy_or_move(_str markid='',_str copymove_option='',boolean do_smartpaste=true,boolean support_deselect=true,int MarkFlags=-1)
{
   int status=0;
 ...
 * @categories Selection_Functions
 */
_command void delete_lines() name_info(','VSARG2_TEXT_BOX|VSARG2_REQUIRES_EDITORCTL) {
...
{
   boolean mdi_with_cmdline = false;
...
*/
   ...
   if (isEclipsePlugin()) {
      ctlbob_banner.p_picture = _find_or_add_picture("_eclipse_banner.bmp");
   }
...
_str aboutUnlicensedFeatures() {
   _str unlicensedFeatures='';
   if (!_haveBuild()) {
      unlicensedFeatures=unlicensedFeatures', Build';
   }
   if (!_haveDebugging()) {
      unlicensedFeatures=unlicensedFeatures', Debugging';
   }
   if (!_haveContextTagging()) {
      unlicensedFeatures=unlicensedFeatures', Context Tagging(TM)';
   }
   if (!_haveVersionControl()) {
      unlicensedFeatures=unlicensedFeatures', Version Control';
   }
   if (!_haveProMacros()) {
      unlicensedFeatures=unlicensedFeatures', Pro Macros';
   }
   if (!_haveBeautifiers()) {
      unlicensedFeatures=unlicensedFeatures', Beautifiers';
   }
   if (!_haveProDiff()) {
      unlicensedFeatures=unlicensedFeatures', Pro Diff';
   }
   if (!_haveMerge()) {
      unlicensedFeatures=unlicensedFeatures', Merge';
   }
   if (!_haveRefactoring()) {
      unlicensedFeatures=unlicensedFeatures', Refactoring';
   }
   if (!_haveRealTimeErrors()) {
      unlicensedFeatures=unlicensedFeatures', Java Real Time Errors';
   }
...
void _cbsave_editorconfig() {
   if (file_eq(_strip_filename(p_buf_name,'P'),'.editorconfig')) {
...
void _SetEditorLanguage(_str lang='',
                        ...
                        boolean preserve_hex_mode=false)
{
   ...
   */
...

   {
      ...
      if ( !bypass_buffer_setup ) {
         ...
         p_LangId=lang;
         p_SoftWrap=_LangOptionsGetPropertyInt32(langOptions,VSLANGPROPNAME_SOFT_WRAP,def_SoftWrap?1:0);
         ...
         boolean spell_check_while_typing=_LangOptionsGetPropertyInt32(langOptions,VSLANGPROPNAME_SPELL_CHECK_WHILE_TYPING,0)!=0 && p_buf_size<=def_use_fundamental_mode_ksize;
         p_spell_check_while_typing=spell_check_while_typing;

         p_SoftWrapOnWord=_LangOptionsGetPropertyInt32(langOptions,VSLANGPROPNAME_SOFT_WRAP_ON_WORD,def_SoftWrapOnWord?1:0);
         ...
         if ( ! read_format_line() ) {
            ...
            p_indent_with_tabs=_LangOptionsGetPropertyInt32(langOptions,VSLANGPROPNAME_INDENT_WITH_TABS,0);
            ...
            p_AutoLeftMargin=_LangOptionsGetPropertyInt32(langOptions,VSLANGPROPNAME_AUTO_LEFT_MARGIN,0);
         ...
         if (def_editorconfig) {
            ...
            _EditorConfigGetProperties(buf_name,ecprops);
            if (ecprops.m_property_set_flags & ECPROPSETFLAG_INDENT_WITH_TABS) {
               p_indent_with_tabs=ecprops.m_indent_with_tabs;
            }
      ...
      boolean in_process=(szEventTableName=="process-keys");
      boolean in_fileman=(szEventTableName=="fileman-keys");
      boolean in_grep=(szEventTableName=="grep-keys");
      _str vi_mode='';
...
static boolean _process_bufferr_filenameNeedsToBeQuoted(_str filename) {
   if (_isUnix()) {
...
void _autocomplete_process(_str insertWord,_str prefix,int &removeStartCol,int &removeLen,boolean onlyInsertWord,struct VS_TAG_BROWSE_INFO symbol)
{
   ...
   */
   ...
   boolean starts_with_quote=substr(complete_arg,1,1)=='"';
...
_command void process_tab(_str autoCompleteAlreadyRunning='', typeless &autoCompleteWords=null) name_info(','VSARG2_CMDLINE|VSARG2_ICON|VSARG2_REQUIRES_EDITORCTL|VSARG2_MARK)
{
   ...
   if ( !command_state() && p_window_state:!='I') {
      ...
      if (file_eq('cd',cur) || file_eq('pushd',cur) || file_eq('rmdir',cur)) {
         do_files=false;
      }
...
_command void process_enter() name_info(','VSARG2_CMDLINE|VSARG2_ICON|VSARG2_REQUIRES_EDITORCTL|VSARG2_MARK)
{
   if ( !command_state() && p_window_state:!='I') {
      ...
      if (file_eq('cd',cur) || file_eq('pushd',cur)) {
         /*
...
{
   if ( ! command_state() && _process_info('b') && p_line:==p_Noflines && name_name(prev_index()):!='root-keydef' && !_in_selection() ) {
      int col;
      if ( _process_info('c') ) {
         col=_process_info('c');
      } else {
...
void _cc_reload_color_coding_profile(_str epackage,_str profileName,boolean doDelete,typeless user_info) {
   _clex_load(profileName);

}
void _convert_vlx_file_to_profile(_str vlx_filename,_str only_convert_profile_name='') {
   _str module='convertvlx2cfgxml.ex';
   ...
   if (only_convert_profile_name!='') {
      only_convert_profile_name=' 'maybe_quote_filename(only_convert_profile_name);
   }
   shell(maybe_quote_filename(filename)' 'maybe_quote_filename(vlx_filename):+only_convert_profile_name);
}
/**
...
_command int cload(_str filename='',_str only_convert_profile_name='') name_info(FILE_ARG','VSARG2_CMDLINE)
{
   ...
   if ( filename=='<' || (filename=='' && _no_child_windows()) ||
        !(p_HasBuffer && (endsWith(filename,VSCFGFILEEXT_CFGXML,false,_fpos_case) || file_eq(_get_extension(filename),'vlx')))
      ) {
   ...
   filename=strip(filename,'B','"');
   if (file_eq(_get_extension(filename),'vlx')) {
...
boolean gExcludeLangIdsIndentWithTabs:[]= _reinit {
   'asm390'=>1,
   'cmake'=>1,  // Not sure about this one
   'cob'=>1,
   //'bourneshell'=>1,
   'cob74'=>1,
   'cob2000'=>1,
   ...
   //'e'=>1,
   'fileman'=>1,
   'for'=>1,  // Not sure about this one but our default tabs are "1 7 250 +3"
   'imakefile'=>1,
   //'java'=>1,
   //'masm'=>1,
   'mak'=>1,
   'npasm'=>1,  // Want tabs +8
   //'pl'=>1,  // Want tabs +8
   'process'=>1,  // Want tabs +8
   //'properties'=>1,  // Want tabs +8
    'py'=>1,
   'tagdoc'=>1,
    //'tcl'=>1,  // Want tabs +8
   //'unixasm'=>1,
...
boolean gExcludeLangIdsTabs:[]= _reinit {
   'asm390'=>1,
   'cmake'=>1,  // Not sure about this one
   'cob'=>1,
   'bourneshell'=>1,
                     ...
                     _str other_iwt,_str other_tabs)
{
   ...
   boolean excludedLangIds:[];

   excludedLangIds=gExcludeLangIdsIndentWithTabs;
   excludedLangIds:['fundamental']=1;
   excludedLangIds:['e']=1;
 ...
 */
static boolean have_doc_comment_style(_str option)
{
   return _plugin_has_property(vsCfgPackage_for_Lang(p_LangId),VSCFGPROFILE_DOC_ALIASES,option)!=0;
 ...
 */
static boolean prompt_for_doc_comment_style(_str orig_comment, int &comment_flags, _str &slcomment_start, _str &mlcomment_start, _str &doxygen_comment_start) 
{
   if (comment_flags==0) {
      ...
      // if the user does not have a preferred document comment format, prompt
...
_command void update_doc_comment() name_info(','VSARG2_REQUIRES_MDI_EDITORCTL)
{
   ...
   if (slcomment_start == "///" && (comment_flags & VSCODEHELP_COMMENTFLAG_XMLDOC)) {
      _xmldoc_update_doc_comment(orig_comment, sigElements, start_col, first_line, last_line);
      _restore_pos2(p);
      return;
   }
 ...
 * @return boolean
 */
static boolean associated_file_exists(_str &filename, _str ext_list, boolean returnAll, _str langId)
{
   mou_hour_glass(true);
   ...
   if (_haveContextTagging() && langId != "" && foundFileList._length() == 0) {
      ...
      loop {
         ...
         foreach (ext in ext_list) {
            ...
            while (status == 0) {
               if (file_eq(_strip_filename(filename_in_tag_file,'P'), filename_no_path"."ext) && file_exists(filename_in_tag_file)) {
...
static _str gassociated_extensions_for_language:[] = {
   ...
   "c"            => "m mm cpp cp cc cxx c++ inl h hpp hp hh hxx h++ resx xaml qth",
   "ada"          => "ada adb ads",
   "d"            => "d di",
   "e"            => "e sh",
   "sv"           => "sv svh svi",
 ...
 */
_str associated_file_for(_str filename, boolean returnAll=false)
{
   ...
   if (!returnAll && filename != "" && file_exists(_unquote_filename(filename))) {
      return _unquote_filename(filename);
   }
 ...
 * @categories Edit_Window_Methods, Editor_Control_Methods, Selection_Functions
 */
_command void copy_lines_down(boolean do_smart_paste=true) name_info(','VSARG2_MULTI_CURSOR|VSARG2_MARK|VSARG2_READ_ONLY|VSARG2_REQUIRES_EDITORCTL)
{
   if (!select_active2()) {
      _deselect();
      select_line();
...
boolean _getAutoMargins(int &leftMargin,int &rightMargin) {
...
static boolean _prevLineInDifferentParagraph(int non_blank_col) {
   boolean result=true;
   save_pos(auto p);
   if(!up() && !_on_line0()) {
      first_non_blank();
 ...
 *                            language.
 */
void _LangInitOptions(VS_LANGUAGE_OPTIONS &langOptions, boolean initForNewLanguage=false,_str newLanguageModeName='') {
   ...
   _LangOptionsSetProperty(langOptions,VSLANGPROPNAME_WORD_CHARS,"");
   _LangOptionsSetProperty(langOptions,VSLANGPROPNAME_WORD_WRAP_FLAGS,STRIP_SPACES_WWS);
...
int _LangOptionsGetPropertyInt32(VS_LANGUAGE_OPTIONS &langOptions,_str propertyName, int defaultValue=0, boolean &apply=null) {
...
long _LangOptionsGetPropertyInt64(VS_LANGUAGE_OPTIONS &langOptions,_str propertyName, long defaultValue=0, boolean &apply=null) {
   typeless value=_LangOptionsGetProperty(langOptions,propertyName,defaultValue,apply);
   if (isinteger(value)) {
      return value;
   }
