...
#define DEFAULT_BEAUTIFIER_EXT  "phpscript=c ada=ada c=c java=c js=c cs=c e=c html=html cfml=html xml=html xsd=html vpj=xml docbook=xml ant=xml as=c d=c android=xml ruby=ruby"   /* Valid beautifier languages */
